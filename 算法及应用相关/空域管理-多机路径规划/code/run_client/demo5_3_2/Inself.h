...
struct Point {
    ...
    Point *parent;
    //初始化坐标
    Point() :x(0), y(0), F(0), G(0), H(0), t(0),parent(NULL)
    {
    }
...
public:
    ...
    void fclearRAM(vector<float_Point *> aa);
...
private:
    ...
    bool isCanreach(const Point *point, const Point *target, bool isIgnoreCorner) const;//judge if there is a solution
