<template>
	<!--
	<view  :style="{backgroundImage: 'url('+imageURL+')'}"  style="background-repeat:no-repeat ;background-size:100% 100%;background-position-x: center;background-position-y: center;background-attachment: fixed;">
	<!--<view class="content" :style="{background: 'url('+imageURL+')',backgroundSize: 'cover'}">
