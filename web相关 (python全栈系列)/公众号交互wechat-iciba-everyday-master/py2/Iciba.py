...
class iciba:
    ...
    def get_error_info(self, errcode):
        return {
            40013: u'不合法的 AppID ，请开发者检查 AppID 的正确性，避免异常字符，注意大小写',
            40125: u'无效的appsecret',
            41001: u'缺少 access_token 参数',
            40003: u'不合法的 OpenID ，请开发者确认 OpenID （该用户）是否已关注公众号，或是否是其他公众号的 OpenID',
            40037: u'无效的模板ID',
