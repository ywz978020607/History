<template>
  <body id="poster">
    <el-form class="login-container" label-position="left" label-width="0px">
      ...
      <el-form-item>
        <el-input type="password" v-model="loginForm.password2" auto-complete="off" placeholder="确认密码"></el-input>
      </el-form-item>
      ...
      <router-link to="/" style="width: 50%" ><span style="float:right">登录</span></router-link>
      </el-form-item>
    </el-form>
  </body>
</template>
