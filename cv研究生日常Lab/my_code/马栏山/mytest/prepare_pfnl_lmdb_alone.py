...
def main(val1="test_damage_B",val2= '/media/x/Database/mls/dataset_png/',val3='/media/x/Database/mls/dataset_lmdb/test_damage_B.lmdb'):
    ...
    if dataset == 'general':
        opt = {}
        opt['dir_name'] = val1 #"test_damage_A"
    
        opt['img_folder'] = val2 #'/media/x/Database/mls/dataset_png/'
        opt['name'] = 'damage_test' #damage_train or damage_val
        # opt['kind_of_damage_or_val'] = 'blur' # 'blur' or 'truth'

        opt['lmdb_save_path'] = val3 #'/media/x/Database/mls/dataset_lmdb/'+opt['dir_name']+'.lmdb'
