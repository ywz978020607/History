...
class PFNL():
    ...
    def test_video(self, inp_idx, save_dir, reuse=False):
        ...
        get border
        """
        border = get_border(lrs[0],0.4) #不除255的整数版塞入 每个视频处理第一帧获取即可
        ...
        for i in pbar:
            ...
            for j in range(test_bs):
                ...
                if (acc_num+1) % cut_part == 0:
                    ...
                    黑边处理 2/2
                    """
                    cat_img = set_black(cat_img,border)
    ...
    def test_videos(self,
        ...
        print("all video key_paths_group num is :")
        print(len(self.dir_vid_index_list))
        #############################################################
        ...
        for idx  in range(start_vid,(end_vid+1)):
            ...
            base_index = 850  #test_damage_B start at 0850
